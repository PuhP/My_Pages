...
const allDishes = [
    // ----------------------------------------------------------------------------------
    // СУПЫ (Soup) - Требование: 2 рыбных, 2 мясных, 2 вегетарианских
    // ----------------------------------------------------------------------------------
    {
    ...
    },
    {
        ...
        price: 255,
        category: 'soup',
        kind: 'meat', // Предположим, что он на мясном бульоне
        count: '300 ml',
    ...
    // Добавлен 2-й рыбный, чтобы довести кол-во до 6 (2 рыбных, 2 мясных, 2 вегетарианских)
    {
    ...
    // ----------------------------------------------------------------------------------
    // ГЛАВНОЕ БЛЮДО (Main Dish) - Требование: 2 рыбных, 2 мясных, 2 вегетарианских
    // ----------------------------------------------------------------------------------
    {
        keyword: 'sashlik',
        name: 'Sashlik',
    ...
    },
    {
        ...
        price: 280,
        category: 'main_dish',
        kind: 'veg', // Делаем его вегетарианским для баланса
        count: '350 г',
    ...
    },
    {
        keyword: 'lasagna',
        name: 'Lasagna',
        price: 385, // Измененная цена по примеру
        category: 'main_dish',
        kind: 'meat', // Используем мясную лазанью
        count: '310 г',
        image: 'foods/lasagna.jpg'
    },
    // Новые главные блюда (доводим до 6)
    {
    ...
    // ----------------------------------------------------------------------------------
    // САЛАТ ИЛИ СТАРТЕР (Starter) - Требование: 1 рыбный, 1 мясной, 4 вегетарианских
    // ----------------------------------------------------------------------------------
    {
    ...
    // ----------------------------------------------------------------------------------
    // НАПИТКИ (Drink) - Требование: 3 холодных, 3 горячих
    // ----------------------------------------------------------------------------------
    {
        keyword: 'tea',
        name: 'Tea',
    ...
    // ----------------------------------------------------------------------------------
    // ДЕСЕРТЫ (Dessert) - Требование: 3 маленьких, 2 средних, 1 большой
    // ----------------------------------------------------------------------------------
    {
    ...
    // ----------------------------------------------------------------------------------
    // ДОБАВКИ (Additive) - Оставлены без изменений, т.к. не указано новое требование
    // ----------------------------------------------------------------------------------
    {
        ...
        price: 50,
        category: 'additive',
        kind: 'cold', // Добавляем kind для единообразия
        count: '200 ml',
    ...
    },
    {
        ...
        price: 150,
        category: 'additive',
        kind: 'hot', // Добавляем kind для единообразия
        count: '300 ml',
